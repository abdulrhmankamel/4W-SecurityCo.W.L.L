document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    eng: {
      ...
      aboutTitle: "About Us",
      aboutText: "4W Security W.L.L., based in Manama, Kingdom of Bahrain, is a trusted provider of security, maintenance, and cleaning services. Operating since 2012, we are backed by over 20 years of management experience, delivering tailored solutions that meet the specific needs of each site. We are proud to offer innovative digital solutions never before introduced in Bahrain, enhancing the quality and efficiency of our operations. Our carefully trained team is supported by a dedicated in-house training department to ensure the highest levels of professionalism, reliability, and service performance.",
      ...
      questionnaireTitle: "Start Your Journey",
      nextBtn: "Next",
    ...
    ar: {
      ...
      aboutTitle: "من نحن",
      aboutText: "شركة 4W للأمن ذ.م.م.، ومقرها المنامة – مملكة البحرين، هي شريك موثوق في تقديم خدمات الأمن، الصيانة، والتنظيف. نحن نعمل منذ عام 2012، ونستند إلى خبرة إدارية تفوق 20 عامًا في تقديم حلول مصممة خصيصًا تلبي متطلبات مختلف المواقع. نفتخر بتقديم حلول رقمية مبتكرة لم يسبق توفيرها في البحرين، مما يعزز من جودة الخدمات وكفاءتها التشغيلية. فريقنا مُدرب بعناية، وبدعم من قسم تدريب داخلي متخصص، نضمن تنفيذ الأعمال بأعلى مستويات الاحترافية والاعتمادية.",
      ...
      cleaningText: "يضمن فريق التنظيف الخبير لدينا أن تكون مقراتكم نظيفة وآمنة ومصانة جيدًا باستخدام حلول صديقة للبيئة.",
      ...
      q4_opt2: "خلال شهر",
      q4_opt3: "أتصفح فقط",
      cleaningHeroTitle: "خدمات تنظيف احترافية",
      cleaningHeroText: "استمتع بالتميز في النظافة مع حلول التنظيف الشاملة التي نصممها خصيصًا لتلبية احتياجاتك.",
      commercialTitle: "التنظيف التجاري",
  ...
  function switchLanguage(lang) {
    ...
    if (heroVideo) {
      ...
      if (videoSource) {
        if (lang === 'ar') {
          videoSource.src = 'introduce_4w_ara.mp4';
        } else {
          videoSource.src = 'introduce_4w_eng.mp4';
        }
        heroVideo.load();
      }
    }
  ...
  // Listen for language change events and set direction
  window.addEventListener('languageChanged', function(e) {
    var lang = (e && e.detail && e.detail.lang) ? e.detail.lang : (document.documentElement.lang || 'eng');
    setDirection(lang);
  });

  // On initial load, set direction
  window.addEventListener('DOMContentLoaded', function() {
    var lang = document.documentElement.lang || 'eng';
    setDirection(lang);
  });
});
